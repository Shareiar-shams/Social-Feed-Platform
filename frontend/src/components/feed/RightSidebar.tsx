      ...
      <div className="_layout_right_sidebar_inner">
        <div className="_feed_right_inner_area_card  _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          ...
          <div className="_feed_bottom_fixed">
            {[
              {img: 'people1.png', title: 'Steve Jobs', para: 'CEO of Apple', inactive: true, time: '5 minute ago'},
              {img: 'people2.png', title: 'Ryan Roslansky', para: 'CEO of Linkedin'},
              {img: 'people3.png', title: 'Dylan Field', para: 'CEO of Figma'},
              {img: 'people1.png', title: 'Steve Jobs', para: 'CEO of Apple', inactive: true, time: '5 minute ago'},
              {img: 'people2.png', title: 'Ryan Roslansky', para: 'CEO of Linkedin'},
              {img: 'people3.png', title: 'Dylan Field', para: 'CEO of Figma'},
              {img: 'people3.png', title: 'Dylan Field', para: 'CEO of Figma'},
              ...
              <div className={`_feed_right_inner_area_card_ppl ${p.inactive ? '_feed_right_inner_area_card_ppl_inactive' : ''}`} key={idx}>
                <div className="_feed_right_inner_area_card_ppl_box">
                  <div className="_feed_right_inner_area_card_ppl_image">
                    <a href="profile.html">
                      <img src={`/assets/images/${p.img}`} alt="" className="_box_ppl_img" />
                    </a>
                  </div>
                  <div className="_feed_right_inner_area_card_ppl_txt">
                    <a href="profile.html">
                      <h4 className="_feed_right_inner_area_card_ppl_title">{p.title}</h4>
                    </a>
                    <p className="_feed_right_inner_area_card_ppl_para">{p.para}</p>
                  </div>
                </div>
