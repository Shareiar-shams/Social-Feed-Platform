      ...
      <div className="container _custom_container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li className="nav-item _header_nav_item">
              <span id="_notify_btn" className="nav-link _header_nav_link _header_notify_btn" onClick={() => setNotifyOpen(v => !v)}>
                ...
                <div id="_notify_drop" className={`_notification_dropdown ${notifyOpen ? 'show' : ''}`}>
                  ...
                  <div className="_notifications_drop_box">
                    ...
                    <div className="_notifications_all">
                      {[...Array(12)].map((_, idx) => (
                        <div className="_notification_box" key={idx}>
